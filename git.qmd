...
3.  `git clone https://github.com/YourGitHubUserName/homework0.git` (change the remote repo to your remote repo).
    ...
    ::: callout-note
    To specify a specific folder to clone to, add the name of the folder after the repository `URL`, like this: `git clone github-repo-URL myfolde`
    :::
...
## Contribute by fork a GitHub repo and commit to the forked repo and create a pull request

20. after forking a GitHub repo to your own GitHub account, `git clone` that account to your local repo.

21. make changes in your local directory.

22. Submitting your changes for review
...
23. Then go to your remote forked repo on the GitHub site and click `Contribute,`and then **Open pull request**, this will take you to the upstream repo. In the form, leave a message explaining the change, and **Create pull request**. **Do not** select `Close pull request` unless you want to cancel the pull request.
...
5.  Then go to your remote forked repo on the GitHub site and click `Contribute,`and then **Open pull request**, this will take you to the upstream repo. In the form, leave a message explaining the change, and **Create pull request**. **Do not** select `Close pull request` unless you want to cancel the pull request.

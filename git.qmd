...
9.  use `git checkout .` to revert back to previous commit. Any changes after the previous commit will be abandoned.
...
11. To permanently go back to a previous commit, use
    ...
    `git reset –hard six_char_commit_ID`git
...
14. you might need to tell GitHub who you are. To to this type the following two commands in our terminal window:
...
21. makes changes to a file, and `git add, commit and push` the changes to the remote repo in your account.

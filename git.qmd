...
11. `git remote -v` Get the reminder of the remote repo

12. if you want to remove the file only from the remote GitHub repository and not remove it from your local filesystem, use:
